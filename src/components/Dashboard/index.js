...
export default function Dashboard() {
  ...
  const [shouldPersonModalBeOpen, setShouldPersonModalBeOpen] = useState(false);
  return (
    <>
      <ToastContainer />
      <div className="bg-gray-200 pb-10">
        <Navbar
          ...
          setGetMovieBy={setGetMovieBy}
          setShouldPersonModalBeOpen={setShouldPersonModalBeOpen}
        />
        ...
        <div className="container px-6 mx-auto">
          <div className="rounded shadow relative bg-white z-10 -mt-8 mb-8 w-full   ">
            <MoviesListing
              getMovieBy={getMovieBy}
              shouldPersonModalBeOpen={shouldPersonModalBeOpen}
              setShouldPersonModalBeOpen={setShouldPersonModalBeOpen}
            />
          </div>
        </div>
